...
public class PeripheralModulesFragment extends ConnectedPeripheralFragment {
    ...
    private final static int MODULE_AWSIOT = 3;
    private final static int MODULE_CALIBRATION = 4;
    private final static int MODULE_DFU = 5;
    ...
    private void onModuleSelected(int moduleId) {
        ...
        switch (moduleId) {
            ...
            case MODULE_AWSIOT:
                fragment = AWSIoTFragment.newInstance(singlePeripheralIdentifier);
                break;
    ...
    private static class ModulesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            switch (viewType) {
                ...
                case kCellType_Module: {
                    ...
                    switch (moduleId) {
                        ...
                        case MODULE_AWSIOT:
                            iconDrawableId = R.drawable.tab_uart_icon;
                            titleId = R.string.awsiot_tab_title;
                            break;
        ...
        private int[] getMenuItems() {
            if (mConnectionMode == CONNECTIONMODE_MULTIPLEPERIPHERAL) {
                ...
                if (hasUart && hasDfu) {
                    return new int[]{MODULE_INFO, MODULE_UART, MODULE_AWSIOT, MODULE_PLOTTER, MODULE_DFU};
                } else if (hasUart) {
                    return new int[]{MODULE_INFO, MODULE_UART, MODULE_AWSIOT, MODULE_PLOTTER};
                } else if (hasDfu) {
